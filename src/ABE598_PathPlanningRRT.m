function [success,q,iterations,npaths,npoints,opt_cost] = ABE598_PathPlanningRRT(S,theta_start,theta_goal,p_robot,r_robot,p_obstacle,r_obstacle,it)
...
for i=1:iterations
    ...
    if collision == 0
        [d_tree_start, tree_start] = RRT(S,tree_start,sample,p_robot,r_robot,p_obstacle,r_obstacle);
        [d_tree_goal, tree_goal] = RRT(S,tree_goal,sample,p_robot,r_robot,p_obstacle,r_obstacle);
    end
